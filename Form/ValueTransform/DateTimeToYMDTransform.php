...
/*
 * Converting datetime-typed value from storage (database) into Y/M/D formated date string.
 */
use Accent\Form\ValueTransform\BaseTransform;


class DateTimeToYMDTransform extends BaseTransform {
    ...
    public function TransformForControl($Value) {
        ...
        $Timestamp= ($Value) ? strtotime("$Value UTC") : -1;
        if ($Timestamp === -1) {
